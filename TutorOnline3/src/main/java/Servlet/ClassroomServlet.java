...
public class ClassroomServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Query all = em.createNamedQuery("Videos.findAll");
        Query vd = em.createNamedQuery("Videos.findByVideoID");
        Query na = em.createNamedQuery("Videos.findByVideoURLd");

        Videos v = em.find(Videos.class, vid);
